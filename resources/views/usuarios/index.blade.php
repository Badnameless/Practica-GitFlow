...
@section('content')
    ...
    <div class="max-w-screen-2xl w-full mx-auto px-4 sm:px-6 lg:px-8 px-4 sm:px-6 lg:px-8 mt-12">
        ...
        <div class="bg-white rounded-md">
            <div class="mb-4 flex items-center justify-end px-8 pt-8"></div>
                        ...
                        <table class="min-w-full">
                          <thead class="bg-mundoVerdeGreen">
                            <tr>
                              ...
                              <th scope="col" class="py-2 pl-4 pr-3 text-left text-sm font-semibold text-white sm:pl-6">Teléfono</th>
